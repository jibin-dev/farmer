...
class packed_widget extends StatefulWidget {
  const packed_widget({super.key});

  @override
  State<packed_widget> createState() => _packed_widgetState();
}

class _packed_widgetState extends State<packed_widget> {
  @override
  ...
  List<dynamic> image = [
    "images/Stem_with_kandari1.jpg",
    "images/COCONT1.jpg",
    "images/Chilly2.jpg",
    "images/Coriander1.jpg",
  ];
  List<String> item = [
