...
class exotic_widget extends StatefulWidget {
  const exotic_widget({super.key});

  @override
  State<exotic_widget> createState() => _exotic_widgetState();
}

class _exotic_widgetState extends State<exotic_widget> {
  @override
